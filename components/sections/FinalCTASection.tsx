  ...
  return (
    <section id="final-cta" className="relative py-24 md:py-32 px-6 scroll-mt-20 z-10">
      <div className="container mx-auto max-w-4xl">
        <div className="relative p-12 md:p-24 rounded-[3rem] md:rounded-[5rem] overflow-hidden text-center border border-[#30f797]/20 bg-gradient-to-b from-[#1A1D2D] to-transparent shadow-2xl">
          ...
          <h2 className="text-4xl md:text-8xl font-black mb-10 relative z-10 leading-none uppercase italic tracking-tighter">
            {finalCta.headline} <br />
            <span className="text-[#30f797]">{finalCta.highlight}</span>
          </h2>

          <div className="relative z-10 max-w-xl mx-auto mb-16">
            <p className="text-lg md:text-2xl text-[#30f797] font-black uppercase tracking-[0.2em] mb-8 italic">
              {finalCta.subheadline}
            </p>
            <p className="text-base md:text-lg text-white/30 font-medium leading-relaxed px-4">
              24/7 Response • 60% No-Show Reduction • 100% Hands-Free.
            </p>
          </div>
          
          <div className="flex flex-col items-center gap-10 relative z-10">
            <PrimaryButton onClick={onCtaClick} className="w-full sm:w-auto text-xl py-8 px-16 shadow-[0_0_50px_rgba(48,247,151,0.3)]">
              {finalCta.ctaText}
            </PrimaryButton>
