...
/**
 * Footer - Enhanced professional SaaS footer.
 * Optimized for mobile: centered layout on small screens, better vertical flow.
 */
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-16 md:gap-12 lg:gap-16 mb-24">
          ...
          <div className="md:col-span-2 flex flex-col items-center md:items-start text-center md:text-left">
            <div className="text-4xl font-black tracking-tighter flex items-center mb-8">
              <span className="text-white">ScaleWith</span>
              <span className="text-[#30f797] ml-1">Waqas</span>
            </div>
            ...
            <div className="flex gap-5">
              <a href="https://linkedin.com/company/masdevs" target="_blank" rel="noopener noreferrer" 
                className="w-12 h-12 flex items-center justify-center rounded-2xl bg-white/5 border border-white/10 hover:border-[#30f797] hover:text-[#30f797] transition-all shadow-lg">
                <Linkedin size={20} />
              </a>
              <a href="https://instagram.com/masdevs.official" target="_blank" rel="noopener noreferrer" 
                className="w-12 h-12 flex items-center justify-center rounded-2xl bg-white/5 border border-white/10 hover:border-[#30f797] hover:text-[#30f797] transition-all shadow-lg">
                <Instagram size={20} />
              </a>
              <a href="https://facebook.com/masdevs.official" target="_blank" rel="noopener noreferrer" 
                className="w-12 h-12 flex items-center justify-center rounded-2xl bg-white/5 border border-white/10 hover:border-[#30f797] hover:text-[#30f797] transition-all shadow-lg">
                <Facebook size={20} />
              </a>
            </div>
            ...
            <ul className="space-y-5">
              {navigation.map((item) => (
                <li key={item.targetId}>
                  <a href={`#${item.targetId}`} className="text-white/40 hover:text-[#30f797] text-base md:text-sm font-bold transition-colors">
                    {item.label}
                  </a>
                </li>
              ))}
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <ul className="space-y-5">
              ...
              <li><a href="#" className="text-white/40 hover:text-[#30f797] text-base md:text-sm font-bold transition-colors">Client Support</a></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start lg:col-span-1 text-center md:text-left">
             ...
             <div className="space-y-8 md:space-y-6">
                ...
                <div className="flex items-center gap-4 text-white/40 justify-center md:justify-start">
                  <Globe size={18} className="text-[#30f797]" />
                  <span className="text-sm font-bold italic">Global Remote Team</span>
                </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          <p className="text-white/20 text-[11px] font-black uppercase tracking-[0.4em] text-center md:text-left leading-relaxed">
            © {currentYear} {brand.name}. All rights reserved. <br className="sm:hidden" /> A MasDevs LLC Brand.
          </p>
